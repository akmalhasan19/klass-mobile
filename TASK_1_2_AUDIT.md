...
| `LLM_ADAPTER_ACTIVE_INTERPRETATION_PROVIDER` | `providers.interpretation.active` | `"xiaomi"` | String | — |
| `LLM_ADAPTER_ACTIVE_DELIVERY_PROVIDER` | `providers.delivery.active` | `"xiaomi"` | String | — |
...
| `LLM_ADAPTER_xiaomi_API_KEY` | `providers.xiaomi.api_key` | *(required)* | String | — |
| `LLM_ADAPTER_xiaomi_BASE_URL` | `providers.xiaomi.base_url` | `"https://generativelanguage.googleapis.com"` | String | — |
| `LLM_ADAPTER_xiaomi_API_VERSION` | `providers.xiaomi.api_version` | `"v1beta"` | String | — |
| `LLM_ADAPTER_xiaomi_INTERPRET_MODEL` | `providers.xiaomi.interpretation_model` | `"xiaomi-2.0-flash"` | String | — |
| `LLM_ADAPTER_xiaomi_DELIVERY_MODEL` | `providers.xiaomi.delivery_model` | `"xiaomi-2.0-flash"` | String | — |

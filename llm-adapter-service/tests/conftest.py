...
def configured_service(monkeypatch: pytest.MonkeyPatch, fake_database_state: _FakeDatabaseState):
    ...
    monkeypatch.setenv("LLM_ADAPTER_ACTIVE_DELIVERY_PROVIDER", "minimax")
    monkeypatch.setenv("LLM_ADAPTER_minimax_API_KEY", "test-minimax-api-key")
    monkeypatch.setenv("LLM_ADAPTER_minimax_BASE_URL", "https://generativelanguage.googleapis.com")
    monkeypatch.setenv("LLM_ADAPTER_minimax_API_VERSION", "v1beta")
    monkeypatch.setenv("LLM_ADAPTER_minimax_INTERPRET_MODEL", "minimax-2.0-flash")
    monkeypatch.setenv("LLM_ADAPTER_minimax_DELIVERY_MODEL", "minimax-2.0-flash")

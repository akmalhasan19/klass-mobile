...
def configured_service(monkeypatch: pytest.MonkeyPatch, fake_database_state: _FakeDatabaseState):
    ...
    monkeypatch.setenv("LLM_ADAPTER_ACTIVE_DELIVERY_PROVIDER", "xiaomi")
    monkeypatch.setenv("LLM_ADAPTER_xiaomi_API_KEY", "test-xiaomi-api-key")
    monkeypatch.setenv("LLM_ADAPTER_xiaomi_BASE_URL", "https://generativelanguage.googleapis.com")
    monkeypatch.setenv("LLM_ADAPTER_xiaomi_API_VERSION", "v1beta")
    monkeypatch.setenv("LLM_ADAPTER_xiaomi_INTERPRET_MODEL", "xiaomi-2.0-flash")
    monkeypatch.setenv("LLM_ADAPTER_xiaomi_DELIVERY_MODEL", "xiaomi-2.0-flash")

...
function renderTitleHero(pptx: any, slide: any, slideData: SlideInput, theme: any): void {
...
function renderSectionHeader(pptx: any, slide: any, slideData: SlideInput, theme: any): void {
...
function renderBulletListIcon(pptx: any, slide: any, slideData: SlideInput, theme: any, isDarkBg: boolean): void {
...
function renderColumnsCard(
  pptx: any, slide: any, slideData: SlideInput, theme: any,
  cardFillColor: string, cardBorderColor: string, targetCols: number,
): void {
  const { yContentStart } = renderSlideHeader(pptx, slide, slideData, theme);
...
function renderMetricHighlight(
  pptx: any, slide: any, slideData: SlideInput, theme: any,
  cardFillColor: string, cardBorderColor: string,
): void {
  const { yContentStart } = renderSlideHeader(pptx, slide, slideData, theme);
  const availableHeight = 7.5 - yContentStart - 0.7;
...
function renderTimelineProcess(pptx: any, slide: any, slideData: SlideInput, theme: any, isDarkBg: boolean): void {
  const { yContentStart } = renderSlideHeader(pptx, slide, slideData, theme);
  const availableHeight = 7.5 - yContentStart - 0.5;
...
function renderQuoteCallout(pptx: any, slide: any, slideData: SlideInput, theme: any): void {
  const contentWidth = 10;
